...
import { get_product_request, product_filter, product_search } from '../Services/Constants/products';
  ...
  return (
    ...
    <div id="navBar">
      <div className="menu">
        <h3>TeeRex Store</h3>
        <FaShoppingCart />
        <i class="fas fa-shopping-cart" aria-hidden="true" style={{fontSize:"35px" , cursor:"pointer"}}
         onClick={()=>{
           navigate("/cart")
         }}
        >
